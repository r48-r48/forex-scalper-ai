...
| Execution | `tests/unit/test_execution_*.py`, `tests/unit/test_scripts_mt5_broker_probe.py`, `tests/unit/test_scripts_mt5_demo_order.py`, `tests/unit/test_scripts_mt5_flatten_positions.py`, `tests/integration/test_execution_workflow.py` | paper adapter, router, live stub, MT5 adapter/client fakes, reconciliation, safe broker probe payloads, controlled demo-order safety gates, position-ticket flattening | no real broker; fake MT5 modules | passed locally |
