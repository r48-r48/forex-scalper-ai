...
- deeper operational hardening for Docker/Compose runtime validation, actual event-loop wiring for concrete live providers, and dependency supervision beyond the current trackers
