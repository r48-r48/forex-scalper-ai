...
- Continue acting on the 2026-04-30 external audit triage after the first runtime Risk/OMS gate, durable recovery, broker-source MT5 hedging, and deal-based accounting slices: next add protective TP/SL/bracket handling, deeper broker-side recovery fault tests, symbol-specific quantization, and real-broker history/deal investigation.
