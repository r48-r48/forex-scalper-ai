...
- deeper operational hardening for Docker/Compose runtime validation, concrete health providers, and dependency supervision beyond the current broker health checks
