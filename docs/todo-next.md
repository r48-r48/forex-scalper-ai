...
- deeper operational hardening for Docker/Compose runtime validation, concrete live provider implementations, and dependency supervision beyond the current injected contracts
