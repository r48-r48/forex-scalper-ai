...
- deeper operational hardening for Docker/Compose runtime validation, MT5 fault-injection/partial-fill coverage, and dependency supervision beyond the current trackers
