...
- deeper operational hardening for Docker/Compose runtime validation, remaining MT5 fault-injection coverage, and dependency supervision beyond the current trackers
