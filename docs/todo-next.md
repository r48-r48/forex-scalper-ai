...
- Continue acting on the 2026-04-30 external audit triage after the first runtime Risk/OMS gate, durable recovery, broker-source MT5 hedging, deal-based accounting, and protective SL/TP slices: next add richer bracket/position-protection workflows, deeper broker-side recovery fault tests, symbol-specific quantization, and real-broker history/deal investigation.
