...
- P0.2 — MT5 Safe Submit Chain from `docs/post-phase-roadmap.md`
...
- continue with P0.2 before event journal and OMS/RiskEngine work unless a blocking live-integration bug appears
