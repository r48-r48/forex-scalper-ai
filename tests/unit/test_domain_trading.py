...
from scalper_ai.domain import FillEvent, LiquidityFlag, OrderIntent, OrderSide, OrderType, PositionState
...
def test_position_state_allows_zero_entry_price_when_flat() -> None:
    state = PositionState(
        symbol="EURUSD",
        timestamp=datetime(2026, 3, 26, 9, 0, tzinfo=timezone.utc),
        net_quantity=0.0,
